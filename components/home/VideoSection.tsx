...
export default function VideoSection() {
  ...
  // Mobile Controls - Fixed positioning at bottom
  ...
  return (
    <section className="relative bg-black lg:hidden">
      ...
      >
        ...
        {/* Gradient Overlays - Adjusted for better text visibility */}
        ...
        <div className="absolute inset-0 flex items-center justify-center px-4 md:px-6">
          <div className="text-center max-w-4xl w-full">
            <div className="mb-6 md:mb-8">
              ...
              <h2 className="text-3xl md:text-5xl lg:text-7xl font-light text-white mb-4 md:mb-6 leading-snug md:leading-tight px-4">
                A New Standard of <br className="hidden md:block" />
                <span className="text-white/95">Urban Living</span>
              </h2>
              
              <p className="text-base md:text-lg lg:text-xl text-white/80 max-w-2xl mx-auto font-light leading-relaxed px-4 md:px-0">
        ...
        {/* Play Button Overlay (shown when paused on tablet) */}
        {!isPlaying && !isMobile && (
          <button
            onClick={togglePlay}
            className="
        ...
        {/* Auto-play notice - Positioned better for mobile */}
